...
const DEFAULT_CONTACTS_CONTENT = {
  ...
  telegramChannelUrl: 'https://t.me/plasma_instrument',
  telegramChannelDisplay: '@plasma_instrument',
...
function normalizeContactsContent(payload) {
  ...
  return {
    ...
    telegramChannelUrl: typeof next.telegramChannelUrl === 'string' ? next.telegramChannelUrl : fallback.telegramChannelUrl,
    telegramChannelDisplay: typeof next.telegramChannelDisplay === 'string' ? next.telegramChannelDisplay : fallback.telegramChannelDisplay,
